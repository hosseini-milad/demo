        ...
        <div className='orderLenzData rxOrder' style={{flexDirection: "initial"}}>
            <div className='lenzData'>
                ...
                {manufactureList&& <Autocomplete
                    ...
                    onChange={(e,value)=>{clearForm("facoryName",value);props.setManufacture(value)}}
                    //onSelect={handleClick}
                    /*onChange={(e,value)=>{setFilterItems({manufacture:value }
                      );props.setPrice('')}}*/
                    renderInput={(params) =>
                    <TextField {...params} //inputProps={{ inputMode: 'numeric' }}
                         label="شرکت" variant="outlined"/>}
            ...
            <div className='lenzData'>
                {manufactureList&& <Autocomplete
                    ...
                    onChange={(e,value)=>{clearForm("brandName",value);props.setBrand(value)}}
                    renderInput={(params) =>
            ...
            <div className='lenzData'>
                {manufactureList&& <Autocomplete
                    ...
                    onChange={(e,value)=>{clearForm("lenzType",value);props.setDodid(value)}}
                    renderInput={(params) =>
            ...
            <div className='lenzData'>
                {manufactureList&& <Autocomplete
                    ...
                    onChange={(e,value)=>{clearForm("material",value)
                      value&&//filterItems.lenzType!=="تدریجی"&&
                      props.setPrice(
                        [manufactureList.priceStatus.paramValue==="active"?
                            manufactureList.rawData.find(item=>item.material===value).lenzPrice1&&
                            manufactureList.rawData.find(item=>item.material===value).lenzPrice1.replaceAll(',', ''):
                        ...
                        manufactureList.priceStatus.paramValue])
                    }}
                ...
                {manufactureList&& <Autocomplete
                    ...
                    onChange={(e,value)=>{setFilterItems(pState => {
                      ...
                      value&&props.setPrice(
                        [manufactureList.priceStatus.paramValue==="active"?
                            manufactureList.rawData.find(item=>item.coridor===value).lenzPrice1.replaceAll(',', ''):
