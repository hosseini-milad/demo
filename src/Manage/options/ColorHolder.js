...
function ColorHolder(){
    ...
    useEffect(() => {
        ...
        fetch(env.siteApi+"/setting/color",postOptions)
            .then(res => res.json())
            .then(
            (result) => {
                setColor(result)
    ...
    return(
        <div className="reyhamPanel">
            ...
            <div className="reyhamItemHolder" key={i}
                onClick={()=>window.location.href="/setting/"+color._id+"?type=color"}>
            ...
            <div className="reyhamItemHolder" 
                onClick={()=>window.location.href="/setting/new?type=color"}>
